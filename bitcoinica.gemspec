...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "bitcoinica.gemspec",
    "lib/bitcoinica.rb",
    "lib/bitcoinica/account.rb",
    "lib/bitcoinica/candlesticks.rb",
    "lib/bitcoinica/connection.rb",
  ...
  s.homepage = %q{http://github.com/andyleclair/bitcoinica}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.7.2}
  s.summary = %q{A Ruby wrapper to the Bitcoinica API}
